...
public class MyAdapterUsuarioPropiedades extends RecyclerView.Adapter<MyAdapterUsuarioPropiedades.MyViewHolder> {

    private Context context;
    private List<ModeloPropiedad>propiedadList;
    private OnItemClickListener listener;

    public MyAdapterUsuarioPropiedades(Context context, List<ModeloPropiedad>propiedadList){
            ...
            if(listener!=null){
                ...
                if(position!=RecyclerView.NO_POSITION){
                    switch (item.getItemId()){
                        case 1:
                            listener.onFavorito(position);
                            return true;
                       case 2:
                           listener.onContacto(position);
                            return true;
                    }
                }
            }
